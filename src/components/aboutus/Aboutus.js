...
const Aboutus = () => {
  ...
  return (
    <>
      ...
      <section
        id="Team"
        className="py-12 sm:py-16 md:py-20 lg:py-24 xl:py-28 2xl:py-32 bg-white"
      >
        <div
        ...
        >
          ...
          {/* Team Grid with horizontal scroll on mobile */}
          <div
            className="
              team-container
          ...
          >
            {teamMembers.map((member, index) => (
              <div
                key={index}
                className="snap-start flex-shrink-0 w-[280px] sm:w-auto
              ...
              >
                {/* Image Container */}
                <div
                  className="w-full aspect-[4/5] max-w-[280px] sm:max-w-[320px] md:max-w-[280px] lg:max-w-[240px] xl:max-w-[260px] 2xl:max-w-[300px]
